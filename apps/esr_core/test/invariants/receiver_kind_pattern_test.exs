defmodule EsrCore.Invariants.ReceiverKindPatternTest do
  @moduledoc """
  ...
  Reference impl: `apps/esr_plugin_feishu/` (`Esr.Entity.FeishuChat` +
  `EsrPluginFeishu.Behavior.FeishuReceive`).
  """
