defmodule Esr.MessageSchemaTest do
  @moduledoc """
  Phase 2 2a-step 2: integration tests for Esr.Message as Ecto.Schema.

  Tests Repo.insert + Repo.get round-trip preserves all struct fields,
  including custom URI type encoding/decoding and {:array, Esr.Ecto.URI}
  for mentions.
  """
