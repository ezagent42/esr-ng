defmodule EsrCore.Repo.Migrations.Phase4Users do
  use Ecto.Migration
  ...
  def change do
    ...
    # initially — must be set via `mix esr.user.set_password user://admin --password X`
    ...
    VALUES ('user://admin', NULL, '[]',
            ...
            strftime('%Y-%m-%d %H:%M:%f', 'now'))
    """, "DELETE FROM users WHERE uri = 'user://admin'"
  end
end
