defmodule EsrDomainIdentity.MixProject do
  use Mix.Project

  def project do
    [
      app: :esr_domain_identity,
      version: "0.1.0",
      build_path: "../../_build",
  ...
  # (not pluggable). Extracted from esr_core so plugins that need user
  # references depend only on this domain app, not on the entire core
  # mechanism stack.
  def application do
    [
      mod: {EsrDomainIdentity.Application, []},
