defmodule EsrCLI.Coercion do
  @moduledoc """
  Convert `Esr.Behavior.interface/0` type declarations into Optimus
  option specs.

  Per Spec 02 §2.C type-mapping table — every type in
  `Esr.InterfaceValidator`'s grammar gets a corresponding Optimus
