defmodule EsrCLI.FacadeRegistry do
  @moduledoc """
  ...
  Mirror of `Esr.SpawnRegistry` + `Esr.TemplateRegistry` pattern:
  ...
  ## API
      ...
      EsrCLI.FacadeRegistry.register(:workspace, :create, &MyPlugin.create_workspace/1, %{
        args: [name: :string],
