defmodule Ezagent.Behavior.RoutingAdmin do
  @moduledoc """
  ...
  `kind: :routing_admin, behavior: Ezagent.Behavior.RoutingAdmin, instance: <routing-admin uri>`.
  ...
  def required_cap_shape do
    %{
      kind: :routing_admin,
      behavior: __MODULE__,
      instance: Ezagent.Entity.RoutingAdmin.default_uri()
    }
  end
end
