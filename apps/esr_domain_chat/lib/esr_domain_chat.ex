defmodule EsrDomainChat do
  ...
  Per #B4: `session://main` is a static child of `EsrDomainChat.Application`
  ...
  `EsrDomainChat.SessionSupervisor` and join `creator_uri` to it.
  ...
  def create_session(short_name, creator_uri) when is_binary(short_name) do
    ...
    case DynamicSupervisor.start_child(EsrDomainChat.SessionSupervisor, spec) do
      {:ok, _pid} ->
