defmodule Esr.Entity.AgentTemplate do
  @moduledoc """
  ...
  Instances are spawned by `Esr.Entity.Agent.spawn/4` (PR 40) and
  composed into team configurations by `Esr.Entity.SessionTemplate`
