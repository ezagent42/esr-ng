defmodule Esr.Orchestrator.Tools do
  @moduledoc """
  ...
  body — calling into `Esr.Entity.Agent.spawn/4` (PR 40),
  `Esr.Entity.SessionTemplate.compute_version_hash/1` (PR 38),
  `Esr.Routing.RuleStore.add/5`, etc — lands in follow-up PRs
  ...
  ## Why an `Esr.Orchestrator.Tools` module instead of `Esr.Behavior.Orchestrator`
