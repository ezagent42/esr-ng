defmodule EzagentPluginCcChannel.BridgeRegistry do
  @moduledoc """
  ...
  ETS-backed, declared in `EzagentPluginCcChannel.Application.start/2`.
  ...
  @table :ezagent_plugin_cc_channel_bridges
