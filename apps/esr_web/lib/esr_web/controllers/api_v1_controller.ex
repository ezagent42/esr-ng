defmodule EsrWeb.ApiV1Controller do
  @moduledoc """
  ...
  call by:
    ...
    4. Building an `Esr.Invocation` and dispatching.
  ...
  defp resolve_caller(conn) do
    case Plug.Conn.get_req_header(conn, "authorization") do
      ...
      _ ->
        ...
        {:ok, Esr.Entity.User.admin_uri(), Esr.Entity.User.admin_caps()}
    end
  end
