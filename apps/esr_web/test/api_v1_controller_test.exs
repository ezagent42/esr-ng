defmodule EsrWeb.ApiV1ControllerTest do
  @moduledoc """
  ...
  setup do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(EsrCore.Repo, shared: true)
  ...
  test "GET /api/v1 lists routes", %{conn: conn} do
    ...
    # is registered on User by esr_domain_identity.Application.
