defmodule Esr.Entity.FeishuChat do
  @moduledoc """
  ...
  `Esr.Behavior.Chat`. When a session's Resolver fans a message out,
  if the routing rules include `feishu://oc_xxx` as a receiver, the
  message reaches this Kind via `Esr.Invocation.dispatch` (CapBAC +
  ...
  @impl Esr.Kind
  def behaviors, do: [EsrPluginFeishu.Behavior.FeishuReceive]
