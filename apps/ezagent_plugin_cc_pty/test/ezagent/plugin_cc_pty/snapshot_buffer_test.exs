defmodule Ezagent.PluginCcPty.SnapshotBufferTest do
  @moduledoc """
  ...
  alias Ezagent.PluginCcPty.PtyServer
  ...
  setup do
    ...
    on_exit(fn ->
      if Process.alive?(pid) do
        _ = DynamicSupervisor.terminate_child(EzagentPluginCcPty.PtyServerSupervisor, pid)
      end
    end)
