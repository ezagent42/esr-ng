defmodule Esr.Template.GenericSession do
  @moduledoc """
  First concrete `Esr.Kind.Template` Class — declare a Session by name
  ...
  ## Why in chat plugin not esr_core
  ...
  relies on:
  - `Esr.SpawnRegistry.spawn/1` returning `{:ok, existing_pid}` if
